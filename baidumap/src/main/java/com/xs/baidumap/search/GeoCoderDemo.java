package com.xs.baidumap.search;
...
public class GeoCoderDemo extends Activity implements OnGetGeoCoderResultListener {
    ...
    public void searchButtonProcess(View v) {
        if (v.getId() == R.id.reversegeocode) {
            ...
            // 反Geo搜索
            LatLng ptCenter1 = new LatLng(23.570022, 115.079807);
    ...
    private void multiPoint() {
        LatLng ptCenter = new LatLng(22.570022, 114.079807);
        // 反Geo搜索
        mSearch.reverseGeoCode(new ReverseGeoCodeOption()
                .location(ptCenter));
    }
...
//        mBaiduMap.clear();
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
        ...
        Log.e("info", "onGetReverseGeoCodeResult: " );
//        mBaiduMap.clear();
        mBaiduMap.addOverlay(new MarkerOptions().position(result.getLocation())
                .icon(BitmapDescriptorFactory
                        .fromResource(R.drawable.icon_marka)));
